...
<script type="text/javascript" charset="utf-8">
			...
			$(document).ready(function() {
				...
				$('#example').dataTable({
				    "sAjaxSource": "core/questions.load.php?type=0",
                                    "bProcessing": true,
                                    "aoColumnDefs": [ 
                                        {
                                            "aTargets": [7], 
                                            ...
                                            "fnRender": function(o, val) {
                                                return "<a href=\"javascript:delRecord('questions', "+ o.aData[7]+", 'questions.php')\"> Delete </a> \
...
function showModal($name = "myModal" , $edit = false){
    ...
    $title = $edit ? "Edit/View Subjective Question" : "Add New Subjective Question";
